...
public final class CachedIntrospectionResults {
    ...
    private static List<BeanInfoFactory> beanInfoFactories =
            SpringFactoriesLoader.loadFactories(BeanInfoFactory.class,
    ...
    public static void clearClassLoader(@Nullable ClassLoader classLoader) {
        ...
        strongClassCache.keySet().removeIf(beanClass -> isUnderneathClassLoader(beanClass.getClassLoader(),
                classLoader));
    ...
    private CachedIntrospectionResults(Class<?> beanClass) throws BeansException {
        try {
            ...
            this.typeDescriptorCache = new ConcurrentHashMap<>();
