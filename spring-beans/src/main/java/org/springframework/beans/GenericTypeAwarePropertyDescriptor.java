...
final class GenericTypeAwarePropertyDescriptor extends PropertyDescriptor {
    ...
    GenericTypeAwarePropertyDescriptor(Class<?> beanClass,String propertyName,@Nullable Method readMethod,
                                       @Nullable Method writeMethod,Class<?> propertyEditorClass)
