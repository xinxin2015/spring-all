...
class TypeConverterDelegate {
    ...
    TypeConverterDelegate(PropertyEditorRegistrySupport propertyEditorRegistry,@Nullable Object targetType) {
        this.propertyEditorRegistry = propertyEditorRegistry;
        this.targetType = targetType;
    }

    @Nullable
    <T> T convertIfNecessary(@Nullable String propertyName,@Nullable Object oldValue,Object newValue,
    ...
    <T> T convertIfNecessary(@Nullable String propertyName, @Nullable Object oldValue, @Nullable Object newValue,
    ...
    private Object doConvertValue(@Nullable Object oldValue,@Nullable Object newValue,@Nullable Class<?> requiredType
     ...
     private Object convertToTypeArray(Object input,@Nullable String propertyName,Class<?> componentType) {
     ...
     private Collection<?> convertToTypedCollection(Collection<?> original,@Nullable String propertyName,
        ...
        for (;it.hasNext();i ++) {
            ...
            Object convertedElement = convertIfNecessary(indexedPropertyName,null,element,(elementType != null ?
                    elementType.getType() : null),elementType);
            try {
