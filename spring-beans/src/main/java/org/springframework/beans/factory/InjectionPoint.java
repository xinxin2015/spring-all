...
public class InjectionPoint {
    ...
    @Nullable
    private volatile Annotation[] fieldAnnotation;
    ...
    protected InjectionPoint(InjectionPoint original) {
        ...
        this.fieldAnnotation = original.fieldAnnotation;
    }
    ...
    public Annotation[] getAnnotations() {
        if (this.field != null) {
            Annotation[] fieldAnnotations = this.fieldAnnotation;
            if (fieldAnnotations == null) {
                fieldAnnotations = this.field.getAnnotations();
                this.fieldAnnotation = fieldAnnotations;
            }
            return fieldAnnotations;
        } else {
            return obtainMethodParameter().getMethodAnnotations();
        }
    }
