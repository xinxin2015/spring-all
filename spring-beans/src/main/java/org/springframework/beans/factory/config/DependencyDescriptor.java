...
public class DependencyDescriptor extends InjectionPoint implements Serializable {
    ...
    public TypeDescriptor getTypeDescriptor() {
        ...
        if (typeDescriptor == null) {
            typeDescriptor = this.field != null ? new TypeDescriptor(getResolvableType(),
                    getDeclaredType(), getAnnotations()) :
            ...
            if (this.fieldName != null) {
                ...
                if (this.methodName != null) {
                    this.methodParameter =
                            new MethodParameter(this.declaringClass.getDeclaredMethod(this.methodName, this.parameterTypes), this.parameterIndex);
                } else {
                    this.methodParameter =
                            new MethodParameter(this.declaringClass.getDeclaredConstructor(this.parameterTypes), this.parameterIndex);
                }
